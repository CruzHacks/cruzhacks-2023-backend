    ...
    return fetch(base_google_endpoint, {
      ...
      .then((g_response) => {
          ...
          if (g_response.success) {
            ...
            if (Object.keys(g_response).includes("error-codes")) {
              ...
              functions.logger.write({
                severity: "ERROR",
                message: "Unable to validate g-response token",
                error: errors,
                user: req.user.sub,
              });
        ...
        functions.logger.write({
          severity: "ALERT",
          message: "Unable to validate g-response token",
          error: "siteVerify response did not include a success field!",
        });
      ...
      .catch((error) => {
        ...
        functions.logger.write({
          severity: "ERROR",
          message: "Error occurred with fetch when attempting to validate g-response token",
          error: error,
        });
